...
<nav class="grid-chat-nav m-4 grid">
	<a href="/" class=" ">
		<div class="h-12 w-12 justify-self-start rounded-full bg-white p-3 hover:bg-gray-50">
			<ArrowLeft />
		</div>
	</a>
	...
	<div class="h-12 w-12 justify-self-end rounded-full bg-white p-3 hover:bg-gray-50">
