<script lang="ts">
	...
	import { type User as UserType, type UserRole } from '$lib/types';
...
<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
	<div class="w-[90%] max-w-md rounded-xl bg-white p-6 shadow-xl">
		<h2 class="mb-4 text-center text-lg font-semibold">Nuovo Utente</h2>
		...
		<div class="flex justify-end space-x-2">
			...
			>
			<button class="item-primary rounded-lg px-4 py-2 text-white" onclick={submitForm}
				>Salva</button
			>
		</div>
	</div>
